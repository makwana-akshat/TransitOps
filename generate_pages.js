...
const pages = ['Dashboard', 'Vehicles', 'Drivers', 'Trips', 'Maintenance', 'Fuel', 'Expenses', 'Reports', 'Users'];
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border bg-card text-card-foreground shadow">
        <div className="flex flex-col space-y-1.5 p-6">
          <h3 className="font-semibold leading-none tracking-tight">${page} Data</h3>
          <p className="text-sm text-muted-foreground">Manage your ${page.toLowerCase()} here.</p>
        </div>
        <div className="p-6 pt-0">
...
export default ${page};
`;
  fs.writeFileSync(path.join(dir, `${page}.jsx`), template);
});
